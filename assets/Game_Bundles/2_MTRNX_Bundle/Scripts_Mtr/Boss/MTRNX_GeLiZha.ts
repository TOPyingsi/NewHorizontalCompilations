...
@ccclass('MTRNX_GeLiZha')
export class MTRNX_GeLiZha extends MTRNX_Unit {
    ...
    public attack: number = 60;//攻击力
    public Hp: number = 2000;//当前生命值
    public maxHp: number = 2000;//最大生命值
