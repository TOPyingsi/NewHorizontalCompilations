...
@ccclass('MTRNX_LoadingPanel')
export class MTRNX_LoadingPanel extends Component {
    head: Node = null;
    ...
    Show(sceneName: string) {
        ...
        this.head = find("ProgressBar/Head", this.node);
        ...
        director.preloadScene(sceneName, (completedCount: number, totalCount: number, item: any) => {
            ...
            director.loadScene(sceneName, () => {
                // UIManager.Instance.HidePanel(Panel.LoadingPanel);
            });
        });
    }
