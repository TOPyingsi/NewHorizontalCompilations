...
@ccclass('SJZ_CharacterEnemy')
export default class SJZ_CharacterEnemy extends SJZ_CharacterController {
    ...
    RefreshEquip() {
        this.weapon = SJZ_DataManager.ItemDataMap.get(SJZ_ItemType.Weapon).find(e => e.Name == "野牛");
        let ammo = SJZ_DataManager.GetItemDataByType(SJZ_ItemType.Ammo, 51314);

        this.weapon.WeaponData.Ammo = ammo;
