import { _decorator, Collider, Collider2D, Contact2DType, IPhysics2DContact, RigidBody2D, v3 } from 'cc';
...
@ccclass('TLWLSJ_GameWeapon_QZB')
export class TLWLSJ_GameWeapon_QZB extends TLWLSJ_GameWeapon {

    rigidBody: RigidBody2D = null;
    collider: Collider2D = null;
    private _data: TLWLSJ_Weapon = null;
    private _harm: number = 10;
    ...
    attack() {
        ...
        this.IsFire = true;
        TLWLSJ_AudioManager.PlaySound(Audios.QZB);
