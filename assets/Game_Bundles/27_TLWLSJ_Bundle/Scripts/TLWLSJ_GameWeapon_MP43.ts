...
@ccclass('TLWLSJ_GameWeapon_MP43')
export class TLWLSJ_GameWeapon_MP43 extends TLWLSJ_GameWeapon {
    Muzzle: Node = null;
    ...
    loadBullet() {
        ...
        TLWLSJ_GameData.subBulletByName(this._bullets[0].Name, fillNum);
        TLWLSJ_AudioManager.PlaySound(Audios.Reload);
        this.playAni(Ani.Reload, false, () => {
            this.IsReload = false;
            this.updateWeaponShow(this._data.CurMagazine);
