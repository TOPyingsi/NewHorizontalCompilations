...
@ccclass("TLWLSJ_GameWeapon_ZDSQ")
export class TLWLSJ_GameWeapon_ZDSQ extends TLWLSJ_GameWeapon {
  Muzzle: Node = null;
  ...
  protected onEnable(): void {
    ...
    TLWLSJ_EventManager.on(TLWLSJ_MyEvent.TLWLSJ_FL, this.FL, this);
  }

  protected onDisable(): void {
    super.onDisable();
    TLWLSJ_EventManager.off(TLWLSJ_MyEvent.TLWLSJ_RELOAD, this.switchMagazine, this);
    TLWLSJ_EventManager.off(TLWLSJ_MyEvent.TLWLSJ_FL, this.FL, this);
  }
}
