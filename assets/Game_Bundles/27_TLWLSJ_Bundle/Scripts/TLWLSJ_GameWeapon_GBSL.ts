...
import TLWLSJ_PlayerController from './TLWLSJ_PlayerController'; import { TLWLSJ_Bullet } from './TLWLSJ_Bullet';
...
export class TLWLSJ_GameWeapon_DCP extends TLWLSJ_GameWeapon {
    ...
    //发射子弹
    fireBullet() {
        BundleManager.LoadPrefab(GameManager.GameData.DefaultBundle, "子弹_高爆手榴弹").then((prefab: Prefab) => {
