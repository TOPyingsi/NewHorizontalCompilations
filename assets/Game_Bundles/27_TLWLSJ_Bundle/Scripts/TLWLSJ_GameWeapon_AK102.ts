...
import TLWLSJ_PlayerController from './TLWLSJ_PlayerController'; import { TLWLSJ_BulletController } from './TLWLSJ_BulletController';
...
@ccclass('TLWLSJ_GameWeapon_AK102')
export class TLWLSJ_GameWeapon_AK102 extends TLWLSJ_GameWeapon {
