...
import TLWLSJ_PlayerController from './TLWLSJ_PlayerController'; import { TLWLSJ_MapCamera } from './TLWLSJ_MapCamera';
...
@ccclass('TLWLSJ_GameWeapon_YBKC')
export class TLWLSJ_GameWeapon_YBKC extends TLWLSJ_GameWeapon {

    rigidBody: RigidBody2D = null;
    collider: Collider2D = null;
    private _data: TLWLSJ_Weapon = null;
    private _harm: number = 50;
    ...
    attack() {
        ...
        this.IsFire = true;
        TLWLSJ_AudioManager.PlaySound(Audios.YBKC);
    ...
    startContact() {
        ...
        TLWLSJ_MapCamera.Instance.shakeCamera();
        this.scheduleOnce(() => {
            this.collider.enabled = false;
        })
