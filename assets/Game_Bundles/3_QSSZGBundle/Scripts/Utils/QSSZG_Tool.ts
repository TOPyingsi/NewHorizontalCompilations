import { _decorator, Component, Node, Vec2, Vec3, instantiate, Prefab, tween, v3, Tween, v2, Sprite, SpriteFrame, Size } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('QSSZG_Tool')
export class QSSZG_Tool extends Component {
    ...
    public static Shaking(node: Node, gap: number, randomMax: number, stopTime: number, callback: Function = null) {
        ...
        tween(node)
            .to(gap, { worldPosition: v3(x + QSSZG_Tool.GetRandom(-randomMax, randomMax), y + QSSZG_Tool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + QSSZG_Tool.GetRandom(-randomMax, randomMax), y + QSSZG_Tool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + QSSZG_Tool.GetRandom(-randomMax, randomMax), y + QSSZG_Tool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + QSSZG_Tool.GetRandom(-randomMax, randomMax), y + QSSZG_Tool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + QSSZG_Tool.GetRandom(-randomMax, randomMax), y + QSSZG_Tool.GetRandom(-randomMax, randomMax), z) })
   ...
   */
    ...
    */
    public static checkIsLowPhone() {
        ...
        return Number(QSSZG_Tool.getBenchmarkLevel()) < checkBenchmark;
    }
