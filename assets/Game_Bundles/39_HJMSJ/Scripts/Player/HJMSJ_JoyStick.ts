...
@ccclass('HJMSJ_JoyStick')
export class HJMSJ_JoyStick extends Component {
    ...
    update(deltaTime: number) {
        if (this.keyboardDir.length() > 0) {
            ...
            director.getScene().emit("哈基米世界_开始移动", this._dir.multiplyScalar(80));
        }
    }
    ...
    onKeyboardStop() {
        ...
        director.getScene().emit("哈基米世界_停止移动");
    }
    ...
    onTouchStart(event: EventTouch) {
        ...
        director.getScene().emit("哈基米世界_开始移动", this._dir);
