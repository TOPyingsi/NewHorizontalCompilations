...
@ccclass('XYRZZ_ZTool')
export class XYRZZ_ZTool extends Component {
    ...
    public static Shaking(node: Node, gap: number, randomMax: number, stopTime: number, callback: Function = null) {
        ...
        tween(node)
            .to(gap, { worldPosition: v3(x + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), y + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), y + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), y + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), y + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), y + XYRZZ_ZTool.GetRandom(-randomMax, randomMax), z) })
   ...
   */
    ...
    */
    public static checkIsLowPhone() {
        ...
        return Number(XYRZZ_ZTool.getBenchmarkLevel()) < checkBenchmark;
    }
