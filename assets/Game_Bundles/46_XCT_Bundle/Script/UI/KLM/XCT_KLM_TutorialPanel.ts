...
@ccclass('XCT_KLM_TutorialPanel')
export class XCT_KLM_TutorialPanel extends XCT_BasePanel {
    ...
    private completeTutorial() {
        ...
        XCT_KLM_DataManager.Instance.isTutorialEnd = true;
        XCT_KLM_DataManager.Instance.isNeedShowDragTutorial = true;
    }
