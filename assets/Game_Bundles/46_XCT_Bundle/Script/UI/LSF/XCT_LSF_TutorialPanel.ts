...
@ccclass('XCT_LSF_TutorialPanel')
export class XCT_LSF_TutorialPanel extends XCT_BasePanel {
    ...
    private completeTutorial() {
        ...
        XCT_LSF_DataManager.Instance.isTutorialEnd = true;
        XCT_LSF_DataManager.Instance.isNeedShowDragTutorial = true;
