...
@ccclass('XCT_LSF_TipPanel')
export class XCT_LSF_TipPanel extends XCT_BasePanel {
    ...
    onBtnExit() {
        ...
        if(XCT_GameManager.Instance.hasStartPanel){
            XCT_UIManager.Instance.hidePanel(XCT_UIPanel.LSF_TipPanel);
            ...
            XCT_UIManager.Instance.showPanel(XCT_UIPanel.TablePanel, null, () => {
                XCT_UIManager.Instance.showPanel(XCT_UIPanel.LoadingPanel, () => {
                    XCT_UIManager.Instance.showPanel(XCT_UIPanel.StartPanel, null, () => {
                        ...
                        XCT_UIManager.Instance.hidePanel(XCT_UIPanel.LSF_TutorialPanel);
                        XCT_UIManager.Instance.hidePanel(XCT_UIPanel.LSF_GamePanel, null, XCT_PanelAnimation.NONE);
                        ...
                        XCT_UIManager.Instance.hidePanel(XCT_UIPanel.LSF_CheckoutPanel);
    ...
    hideNoMoneyTipPanel() {
              if(!XCT_LSF_DataManager.Instance.isShowingShopPanel){
                EventManager.Scene.emit(XCT_Events.Game_Resume);
            }
        XCT_AudioManager.getInstance().playSound("点击");
        XCT_UIManager.Instance.hidePanel(XCT_UIPanel.LSF_TipPanel);
    ...
    btnVideoClick() {
        ...
        Banner.Instance.ShowVideoAd(() => {
            // 假设视频播放完成
            XCT_LSF_DataManager.Instance.playerData.money += 200;
    ...
    btnVideoOpenTakeoutClick() {
        ...
        // 这里应该调用视频广告接口
        Banner.Instance.ShowVideoAd(() => {
            XCT_LSF_DataManager.Instance.playerData.isTakeOutProjectOpen = true;
            EventManager.Scene.emit(XCT_Events.LSF_Takeout_Open);
            // 假设视频播放完成
            XCT_UIManager.Instance.showPanel(XCT_UIPanel.LSF_TakeoutPanel, null, () => {
                XCT_UIManager.Instance.hidePanel(XCT_UIPanel.LSF_TipPanel);
            });
        });
    }
    ...
    addListener() {
        ...
        EventManager.on(XCT_Events.LSF_ShowTip_Back, this.showBackTipPanel, this);
        EventManager.on(XCT_Events.LSF_ShowTip_NoMoney, this.showNoMoneyTipPanel, this);
        EventManager.on(XCT_Events.LSF_ShowTip_OpenTakeout, this.showOpenTakeoutPanel, this);
    ...
    removeListener() {
        ...
        EventManager.off(XCT_Events.LSF_ShowTip_Back, this.showBackTipPanel, this);
        EventManager.off(XCT_Events.LSF_ShowTip_NoMoney, this.showNoMoneyTipPanel, this);
        EventManager.off(XCT_Events.LSF_ShowTip_OpenTakeout, this.showOpenTakeoutPanel, this);
