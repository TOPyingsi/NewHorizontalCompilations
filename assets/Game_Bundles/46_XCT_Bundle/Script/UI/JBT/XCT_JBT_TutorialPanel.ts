...
@ccclass('XCT_JBT_TutorialPanel')
export class XCT_JBT_TutorialPanel extends XCT_BasePanel {
    ...
    private completeTutorial() {
        ...
        XCT_JBT_DataManager.Instance.isTutorialEnd = true;
        XCT_JBT_DataManager.Instance.isNeedShowDragTutorial = true;
    }
