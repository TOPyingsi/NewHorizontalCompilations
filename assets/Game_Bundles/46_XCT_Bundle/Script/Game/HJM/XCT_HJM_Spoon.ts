...
@ccclass('XCT_HJM_Spoon')
export class XCT_HJM_Spoon extends Component {
    ...
    private onTouchEnd(): void {
        ...
        if (this.water.getComponent(UIOpacity).opacity == 0) {
            ...
            if (XCT_HJM_DataManager.Instance.tutorialIdx == 4) {
    ...
    private playSpoonAnimation() {
        ...
        this.scheduleOnce(() => {
            ...
            EventManager.Scene.emit(XCT_Events.HJM_Change_CookArea);
