...
@ccclass('XCT_LSF_Bowl')
export class XCT_LSF_Bowl extends Component {
    ...
    private addListener() {
        EventManager.on(XCT_Events.LSF_Change_CookArea, this.moveToPos2, this);
    }

    private removeListener() {
        EventManager.off(XCT_Events.LSF_Change_CookArea, this.moveToPos2, this);
    }
